use super::{
    geometry::{Atomic, BoundingBox, Point, Point4D, Vector, Vector3D},
    matrix::Matrix4X4,
};
...
// impl Point<'_> for Vertex {
//     type VectorType = Vector3D;

//     fn vector_from<'a>(&self, point: &impl Point<'a>) -> Self::VectorType {
//         Vector3D::new(
//             self.x - point.get_x(),
//             self.y - point.get_y(),
//             self.z - point.get_z(),
...
//     fn vector_to<'a>(&self, point: &impl Point<'a>) -> Self::VectorType {
//         Vector3D::new(
//             point.get_x() - self.x,
//             point.get_y() - self.y,
//             point.get_z() - self.z,
